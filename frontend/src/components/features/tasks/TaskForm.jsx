...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const dataToSubmit = {
      ...
      // IMPORTANT: Always include assigned_to_users, even when empty
      assigned_to_users: assignedUsers.map(user => user._id) // This will be an empty array if no users are assigned
    };
